...
#  By Luka S.J Updated by A.I.R for v21.1
#-------------------------------------------------------------------------------
  ...
  def self.randomizeTrainers
    ...
    for key in data.keys
      ...
      for i in 0...data[key].pokemon.length
        ...
        temp_pkmn = Randomizer.all_species.sample
        if data[key].pokemon[i][:level] > 35 && Randomizer.getNextEvos(temp_pkmn).length > 0
          evolved_pkmn = Randomizer.getNextEvos(temp_pkmn).last
...
#===============================================================================
#  Replacing Method to randomize static battles
#===============================================================================
class WildBattle
...
class PokemonLoadScreen
  ...
  def pbStartLoadScreen
    ...
    $PokemonGlobal.isRandomizer = nil
    $PokemonGlobal.randomizerRules = nil
    $PokemonGlobal.randomizerRules = [:TRAINERS, :ENCOUNTERS, :ITEMS]
